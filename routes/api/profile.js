...
router.get('/github/:username', (req, res) => {
  try {
    const options = {
      uri: `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client-id=${config.get('githubClientId')}&client_seret=${config.get('githubSecret')}`,
      method: 'GET',
